...
public:
    ...
    int unifMode; // A handle for the "uniform" float representing overlay in shader
...
public:
    ...
    // Pass the given player position to this shader on the GPU
    ...
    void overlayType(const int type);
    void blockTexture(const int slot);
